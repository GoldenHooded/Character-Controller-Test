...
using UnityEngine;
using GoldenHooded.CharacterController.Internal;
using static GoldenHooded.CharacterController.Internal.Math;
using static GoldenHooded.CharacterController.Internal.MathUtils;
using static GoldenHooded.CharacterController.Internal.StepDetectionUtils;
using static GoldenHooded.CharacterController.Internal.MovementSurfaceUtils;
using static GoldenHooded.CharacterController.Internal.GeometricTests;
using static GoldenHooded.CharacterController.Internal.OverlapUtils;
using static GoldenHooded.CharacterController.Internal.SweepTestsWithPadding;
using Plane = GoldenHooded.CharacterController.Internal.Plane;

namespace GoldenHooded.CharacterController
{
